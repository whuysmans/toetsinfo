...
const buildResultTable = ( restData, graphqlData ) => {
	...
	const tableBody = `<tbody>
		...
		<tr class="hover-container"><td>${ oneQuestionAtATime.description }</td><td>${ oneQuestionAtATime.value === true ? 'Ja' : 'Nee' }</td><td style="background-color:${ rowColor(oneQuestionAtATime) }">${ oneQuestionAtATime.value === oneQuestionAtATime.expectedValue ? 'OK' : 'OK?' }</td><td class="hover-target">&#9432;<aside class="hover-popup"><p>Heb je ervoor gekozen om je vragen een voor een aan te bieden en is dit in lijn met eventuele opleidingsspecifieke afspraken?Op deze pagina kan je eventuele opleidingsspecifieke afspraken nog eens checken: <a href="https://canvas.kdg.be/courses/24981/pages/waar-vind-ik-de-exameninstructies-en-handleidingen-voor-mijn-opleiding" target="_blank">https://canvas.kdg.be/courses/24981/pages/waar-vind-ik-de-exameninstructies-en-handleidingen-voor-mijn-opleiding</a></p></aside></td></tr>
