...
const buildResultTable = ( restData, graphqlData, quizURL, quizID, itemsData ) => {
	...
	const laatsteVraag = {
		...
		value: itemsData[itemsData.length - 1].entry_type === 'Stimulus' && ( itemsData[itemsData.length - 1].entry.title === "Laatste vraag" || itemsData[itemsData.length - 1].entry.title === "Final question" ),
		expectedValue: true,
		severity: 'orange'
	}
	const linkInModule = {
